...
func (provider *CohereProvider) listModelsByKey(ctx context.Context, key schemas.Key, request *schemas.BifrostListModelsRequest) (*schemas.BifrostListModelsResponse, *schemas.BifrostError) {
	...
	// Build URL
	req.SetRequestURI(provider.networkConfig.BaseURL + providerUtils.GetRequestPath(ctx, fmt.Sprintf("/v1/models?%s", params.Encode()), provider.customProviderConfig, schemas.ListModelsRequest))
...
func (provider *CohereProvider) ChatCompletion(ctx context.Context, key schemas.Key, request *schemas.BifrostChatRequest) (*schemas.BifrostChatResponse, *schemas.BifrostError) {
	...
	responseBody, latency, err := provider.completeRequest(ctx, jsonBody, provider.networkConfig.BaseURL+providerUtils.GetRequestPath(ctx, "/v2/chat", provider.customProviderConfig, schemas.ChatCompletionRequest), key.Value)
	if err != nil {
		return nil, err
	}
...
func (provider *CohereProvider) ChatCompletionStream(ctx context.Context, postHookRunner schemas.PostHookRunner, key schemas.Key, request *schemas.BifrostChatRequest) (chan *schemas.BifrostStream, *schemas.BifrostError) {
	...
	req.Header.SetMethod(http.MethodPost)
	req.SetRequestURI(provider.networkConfig.BaseURL + providerUtils.GetRequestPath(ctx, "/v2/chat", provider.customProviderConfig, schemas.ChatCompletionStreamRequest))
	req.Header.SetContentType("application/json")
...
func (provider *CohereProvider) Responses(ctx context.Context, key schemas.Key, request *schemas.BifrostResponsesRequest) (*schemas.BifrostResponsesResponse, *schemas.BifrostError) {
	...
	// Convert to Cohere v2 request
	responseBody, latency, err := provider.completeRequest(ctx, jsonBody, provider.networkConfig.BaseURL+providerUtils.GetRequestPath(ctx, "/v2/chat", provider.customProviderConfig, schemas.ResponsesRequest), key.Value)
	if err != nil {
		return nil, err
	}
...
func (provider *CohereProvider) ResponsesStream(ctx context.Context, postHookRunner schemas.PostHookRunner, key schemas.Key, request *schemas.BifrostResponsesRequest) (chan *schemas.BifrostStream, *schemas.BifrostError) {
	...
	req.Header.SetMethod(http.MethodPost)
	req.SetRequestURI(provider.networkConfig.BaseURL + providerUtils.GetRequestPath(ctx, "/v2/chat", provider.customProviderConfig, schemas.ResponsesStreamRequest))
	req.Header.SetContentType("application/json")
	providerUtils.SetExtraHeaders(ctx, req, provider.networkConfig.ExtraHeaders, nil)
...
func (provider *CohereProvider) Embedding(ctx context.Context, key schemas.Key, request *schemas.BifrostEmbeddingRequest) (*schemas.BifrostEmbeddingResponse, *schemas.BifrostError) {
	...
	responseBody, latency, err := provider.completeRequest(ctx, jsonBody, provider.networkConfig.BaseURL+providerUtils.GetRequestPath(ctx, "/v2/embed", provider.customProviderConfig, schemas.EmbeddingRequest), key.Value)
	if err != nil {
		return nil, err
	}
